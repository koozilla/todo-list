      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 py-12 sm:py-20">
        <div className="text-center">
          ...
          <p className="text-xl sm:text-2xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-12 leading-relaxed">
            A modern, intuitive task management app that helps you stay organized, 
            boost productivity, and achieve your goals with beautiful design and powerful features.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400">Categorize, prioritize, and organize tasks with ease</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Deadline Management</h3>
              <p className="text-gray-600 dark:text-gray-400">Never miss important deadlines with smart reminders</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Dark Mode Ready</h3>
              <p className="text-gray-600 dark:text-gray-400">Beautiful interface that adapts to your preference</p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
            ...
            <Link
              href="/auth/login"
              className="inline-flex items-center px-8 py-4 text-lg font-semibold text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 border-2 border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-full shadow-lg transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
            >
              <svg className="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="mt-20 text-center">
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">Trusted by productivity enthusiasts worldwide</p>
